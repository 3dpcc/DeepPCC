...
class Coder():
    ...
    def encode(self, x, postfix=''):
        ...
        #print(f'---------------out2:{y_list[0].shape}---')
        #print(f'---------------out1:{y_list[1].shape}---')
        #print(f'---------------out0:{y_list[2].shape}---')
        y = sort_sparse_tensor(y_list[0])
        #y = y_list[0]
        # print(f'--------------------y_list[0]:{y_list[0]}-------------')
        #print(f'--------------------y C1:{y.C}-------------')
       # print(f'--------------------y f1:{y.F}-------------')
...
if __name__ == '__main__':
    ...
    if args.scaling_factor!=1: 
        ...
        x_in = x
    # write_ply_ascii_geo(filename + '_downscale.ply', x_in.C.detach().cpu().numpy()[:, 1:])
