...
from pct_pos.transformer_enc_0 import Pct_0
from pct_pos.transformer_enc_1 import Pct_1
from pct_pos.transformer_enc_2 import Pct_2
from pct_pos.transformer_dec_0 import Pct_0_0
from pct_pos.transformer_dec_1 import Pct_1_0
from pct_pos.transformer_dec_2 import Pct_2_0
import numpy as np
...
class Encoder(torch.nn.Module):
    def __init__(self, channels=[1,16,32,64,32,8]):
        ...
        self.conv3 = ME.MinkowskiConvolution(
            ...
            bias=True,
            dimension=3)
        self.Pct_0=Pct_0(channels[2])
        self.Pct_1=Pct_1(channels[3])
        self.Pct_2=Pct_2(channels[4])
...
class Decoder(torch.nn.Module):
    ...
    def __init__(self, channels=[8,64,32,16]):
        ...
        self.Pct0_0=Pct_0_0(channels[0])
        self.Pct1_0=Pct_1_0(channels[1])
        self.Pct2_0=Pct_2_0(channels[2])
    ...
    def prune_voxel(self, data, data_cls, nums, ground_truth, training):
        ...
        if training: 
            ...
            mask = mask_topk + mask_true#训练时，选取在groundtruth存在的点并且为F估计的topk的点
        else: 
            mask = mask_topk#test时，选取topk的点
